import { ArrowLeft, Mail, Lightbulb, Shield, Clock } from 'lucide-react';
          ...
          <div className="bg-muted/50 rounded-lg p-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <p className="font-medium">
                  {unlockDate.toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' })}
                </p>
              </div>
              <div>
                <p className="text-muted-foreground mb-1">Unlock At</p>
                <p className="font-medium">
                  {unlockDate.toLocaleTimeString('en-GB', { hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: false })} UTC
                </p>
              </div>
            </div>
            ...
            {hasTimestamp && (
              <div className="pt-2 border-t border-border">
                <p className="text-sm text-muted-foreground">
                  <span className="font-medium">Time Locked:</span> {calculateTimeLocked(capsule.metadata.createdAt, capsule.metadata.unlockAt)}
                </p>
              </div>
            )}
            ...
            <>
              <div className="space-y-3">
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <span className="capitalize">{capsule.content.loveCapsule.category}</span>
                </div>
            ...
            <>
              <div className="space-y-3">
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <span className="capitalize">{capsule.content.predictionCapsule.category.replace(/([A-Z])/g, ' $1').trim()}</span>
                </div>
                ...
                <div className="bg-muted/50 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-medium">Commit ID (Proof of Immutability)</span>
                  </div>
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    This cryptographic hash proves the prediction was made before the unlock date.
                  </p>
                </div>
              </div>
            </>
