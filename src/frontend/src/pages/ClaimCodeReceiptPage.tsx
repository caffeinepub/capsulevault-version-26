import { Check, Clock, Copy, Download, Home, Share2 } from "lucide-react";
...
export function ClaimCodeReceiptPage({
  capsule,
  onNavigate,
}: ClaimCodeReceiptPageProps) {
    ...
    <div className="container mx-auto px-4 py-12 max-w-2xl">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground">
          Your {isPrediction ? "prediction" : "message"} has been securely
          locked
        </p>
      </div>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            Share this code with the recipient. They'll need it to unlock the
            capsule.
          </CardDescription>
        </CardHeader>
            ...
            <div className="bg-muted/50 rounded-lg p-3 mb-3">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {capsule.metadata.createdAtTimestamp!.time}{" "}
                    {capsule.metadata.createdAtTimestamp!.timezone}
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="bg-muted/50 rounded-lg p-6 mb-6">
        ...
        <ol className="space-y-2 text-sm text-muted-foreground list-decimal list-inside">
          <li>
            Keep your claim code safe. It's the only way to access your capsule.
          </li>
          <li>
            To open the capsule, go to the official CapsuleVault site, select
            'Open Capsule,' and enter your claim code when the unlock date
            arrives.
          </li>
        ...
        {isPrediction && (
          <p className="mt-2 text-sm text-muted-foreground">
            The commit ID proves your prediction was made before the unlock
            date.
          </p>
        )}
      </div>
