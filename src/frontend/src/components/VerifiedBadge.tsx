...
export function VerifiedBadge({ integrityHash, className = '' }: VerifiedBadgeProps) {
        ...
        <TooltipContent className="max-w-xs">
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              This capsule was created on the official CapsuleVault site:
            </p>
            <code className="text-xs block bg-muted px-2 py-1 rounded">
              https://capsulevault-1ie.caffeine.xyz/
            </code>
            <p className="text-xs text-muted-foreground">
              Integrity Hash: <code className="text-xs">{displayHash.slice(0, 16)}...</code>
            </p>
          </div>
        </TooltipContent>
      </Tooltip>
